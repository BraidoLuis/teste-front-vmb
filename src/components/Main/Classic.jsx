        ...
        <section className="container mx-auto p-10">
            <div className='flex flex-col items-center md:flex-row gap-12'>
                ...
                <div className='w-full md:w-1/2'>
                    ...
                    <p className="font-hedvig font-light text-2xl text-[#686868] mb-6">
                    ...
                    <button className="bg-[#61A9CC] w-[200px] text-left text-white uppercase py-2 px-6 text-sm font-semibold hover:bg-[#5390ae] transition-colors duration-300 rounded-[3px] cursor-pointer">
                        Explore
                    </button>
                </div>
            </div>
