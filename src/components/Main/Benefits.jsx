...
export default function Benefits() {
    return (
        <section className="container mx-auto p-10 flex justify-between items-center">
            <div className="flex-1 flex justify-start">
                <FaCreditCard className="inline-block w-8 h-9 text-[#61A9CC] mr-2" />
            ...
            <div className="flex-1 flex justify-center">
                <PiSealPercentLight className="inline-block w-8 h-9 text-[#61A9CC] mr-2" />
                <div className='flex flex-col'>
            ...
            <div className="flex-1 flex justify-end">
                <FaCoins className="inline-block w-8 h-9 text-[#61A9CC] mr-2" />
                <div className='flex flex-col'>
